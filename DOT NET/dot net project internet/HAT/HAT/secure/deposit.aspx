<%@ Page Language="C#" Theme="default" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="deposit.aspx.cs" Inherits="receipt" Title="HAT: Deposits" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:FormView ID="FormView1" runat="server" CellPadding="4" ForeColor="#333333" DataSourceID="AccessDataSource1"
        ...
        <InsertItemTemplate>
            <table width="100%">
                <tr align="left">
                    <td align="center" style="background-color:#507CD1;color:#ffffff;font-weight:bold;" colspan="3">Add Deposit Details</td>
                </tr>
                <tr align="left">
                    <td>
                        Receipt Head</td>
    ...
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="~/App_Data/household.mdb"
        SelectCommand="SELECT * FROM [deposits]"
         InsertCommand="INSERT INTO [deposits] (headid, rdate, ramount, rmode, rdesc) VALUES (@headid, @rdate, @ramount, @rmode, @rdesc)"></asp:AccessDataSource>
</asp:Content>
